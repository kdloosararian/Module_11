# Module_11
Module 11 challenge HTML/ splinter web scraping 
...
Help getting chrome drive working with ASk BCS/ using stackflow for scripting help and class files from the week.
